...
<script type="text/javascript">
	...
	$(function(){
		...
		$(window).keydown(function (e){
			if(e.keyCode==13){
				$("#saveCreateActivityRemarkBtn").click();
			}
		});
...
<%--					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime:remark.editTime} 由${remark.editFlag=='0'?remark.createBy:remark.editBy}${remark.editFlag=='0'?'创建':'修改'}</small>--%>
					<font color="gray">市场活动</font> <font color="gray">-</font> <b>${activity.name}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime.concat("由").concat(remark.createBy).concat("创建"):remark.editTime.concat("由").concat(remark.editBy).concat("修改")}</small>
