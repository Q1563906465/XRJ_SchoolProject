...
<div class="modal fade" id="editRemarkModal" role="dialog">
	...
	<div style="position: relative; left: 40px; top: -50px;">
		阶段&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<!--遍历stageList，依次显示每一个交易阶段的图标-->
		<c:forEach items="${stageList}" var="stage">
			<!--如果stage是当前交易阶段，图标显示为map-marker，颜色为绿色-->
			...
			<!--如果stage在当前交易阶段前，图标显示为ok-circle，颜色为绿色-->
			...
			<!--如果stage在当前交易阶段后，图标显示为record，颜色为黑色-->
			<c:if test="${tran.orderNo<stage.orderNo}">
				<span class="glyphicon glyphicon-record mystage" data-toggle="popover" data-placement="bottom" data-content="${stage.value}" style=""></span>
				-----------
			</c:if>
		</c:forEach>
