			...
			$.ajax({
				...
				success:function(data){
					if(data.code=="1"){
						...
						htmlStr+="		<font color=\"gray\">客户</font> <font color=\"gray\">-</font> <b>${customer.name}-${customer.website}</b> <small style=\"color: gray;\">"+data.retData.createTime+" 由${sessionScope.sessionUser.name}创建</small>";
		...
		<c:forEach items="${customerRemarkList}" var="remark">
			<div class="remarkDiv" id="div_${remark.id}" style="height: 60px;">
				...
				<div style="position: relative; top: -40px; left: 40px;" >
					...
					<font color="gray">客户</font> <font color="gray">-</font> <b>${customer.name}-${customer.website}</b> <small style="color: gray;"> ${remark.editFlag=='0'?remark.createTime.concat("由").concat(remark.createBy).concat("创建"):remark.editTime.concat("由").concat(remark.editBy).concat("修改")}</small>
