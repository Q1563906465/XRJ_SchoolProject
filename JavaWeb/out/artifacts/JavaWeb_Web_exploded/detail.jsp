			...
			<div class="body_c">
				<div class="table">
					<table>
						<tr>
							<td colspan="2">
								<img src="${requestScope.detail.img}" />
							</td>
						</tr>
						<tr>
							<td>商品名：</td>
							<td>${requestScope.detail.fname}</td>
						</tr>
						<tr>
							<td>价格：</td>
						...
						<tr>
							<td>故事：</td>
							<td style="font-size: 18px; line-height: 30px;">${requestScope.detail.story}</td>
						</tr>
						<tr>
							<td>
								<a href="addCartServlet?id=${requestScope.detail.id}"><button type="button" name="cart">加入购物车</button></a>
							</td>

							<td>
								<a href="cart.jsp"><button type="button" value="">返回购物车</button></a>
							</td>
						</tr>
					</table>
